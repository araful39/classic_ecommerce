            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Obx(
                    () =>
                        CustomTextWidget(text: "${double.parse(checkoutController.data['total_amount'] ?? "0").toStringAsFixed(2)} ৳", fontSize: 16),
                  )
                ],
              ),
              Row(
              ...
              Row(
                ...
                children: [
                  ...
                  Obx(
                    () => CustomTextWidget(text: "${checkoutController.deliveryCharge.value.toStringAsFixed(2)}  ৳", fontSize: 16),
                  )
                ],
              ),
              const Divider(),
              Row(
                ...
                children: [
                  ...
                  Obx(
                    () => CustomTextWidget(
                      text: "${checkoutController.payableAmount.value.toStringAsFixed(2)}  ৳",
                      fontSize: 18,
                      fontColor: AppColors.bg1LightColor,
                      fontWeight: FontWeight.w500,
                    ),
